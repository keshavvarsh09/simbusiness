...
-- Dropshipping checklist steps (static reference)
...
-- Dropshipping progress (user tracking)
  ...
  try {
    ...
    try {
      ...
      const expectedTables = [
        ...
        'ad_campaigns',
        'dropshipping_checklist_steps',
        'dropshipping_progress',
        'dropshipping_mcq_answers'
      ];
