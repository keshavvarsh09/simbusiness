...
import { getGoogleAdsStrategy } from '@/lib/gemini';
...
export async function POST(request: NextRequest) {
  try {
    ...
    const strategy = await getGoogleAdsStrategy(productInfo, parseFloat(budget));
    ...
    console.error('Google ads strategy error:', error);
    return NextResponse.json(
