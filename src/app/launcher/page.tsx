...
const LEARNING_MODULES = [
  ...
  },
  {
    ...
    lessons: [
      { id: '5.1', title: 'Email Sequences', description: 'Welcome, nurture, and win-back flows', duration: '25 min', route: '/email' },
      { id: '5.2', title: 'Abandoned Cart Recovery', description: 'Recover 60-70% abandoned carts', duration: '20 min', route: '/email' },
      { id: '5.3', title: 'Upsell Funnels', description: 'Increase AOV with order bumps', duration: '20 min', route: '/email' },
    ],
  ...
  },
  {
    ...
    lessons: [
      { id: '6.1', title: 'Ready to Scale?', description: 'Key metrics that signal scaling opportunity', duration: '15 min', route: '/scaling' },
      { id: '6.2', title: 'Budget Allocation', description: 'Organic vs Paid by revenue stage', duration: '25 min', route: '/scaling' },
      { id: '6.3', title: 'Multi-Channel', description: 'TikTok Shop + Facebook + Amazon', duration: '30 min', route: '/scaling' },
      { id: '6.4', title: 'Brand Building', description: 'From dropshipping to real brand', duration: '20 min', route: '/scaling' },
    ],
